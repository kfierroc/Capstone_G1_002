...
/// 2. Ejecutar el script supabase_schema_actualizado.sql en el SQL Editor
...
class SupabaseConfig {
  ...
  static Future<void> initialize() async {
    try {
      ...
      debugPrint('✅ Supabase inicializado correctamente en Residente');
    } catch (e) {
      debugPrint('❌ Error al inicializar Supabase en Residente: $e');
